 ...
 */
package com.example.fangli.mymvpdemo.ui.viewholder;
 ...
 * 参考BGANormalRefreshViewHolder、BGAStickinessRefreshViewHolder、BGAMoocStyleRefreshViewHolder、BGAMeiTuanRefreshViewHolder
 */
